...
export default function DashboardPage() {
  return (
    <>
      ...
      {/* 4. Domain sections (10 sections, collapsible) */}
      ...
      {/* 6. Footer */}
      <footer style={{ background: '#1A1A1A', padding: '48px 0', textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{
            ...
            fontSize: 11, color: '#6B7280', letterSpacing: '1px', margin: '0 0 24px',
          }}>
            Built on 24 Postgres tables &middot; 2.19M rows &middot; 30+ public data sources
          </p>
          <div style={{
            display: 'flex', justifyContent: 'center', gap: 32,
            fontFamily: 'var(--font-body), sans-serif', fontSize: 13, color: '#9CA3AF',
          }}>
